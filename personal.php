...
$result = mysql_query("SELECT * FROM task WHERE (Status='Overdue' AND Type='Personal')");
...
$result = mysql_query("SELECT * FROM task WHERE (Status='Due' AND Type='Personal')");
...
$result = mysql_query("SELECT * FROM task WHERE (Status='Complete' AND Type='Personal')");
